...
public class SwipeBackLayout extends FrameLayout {
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.base_SwipeBackLayout,
                defStyle, R.style.base_SwipeBackLayout);

        int edgeSize = a.getDimensionPixelSize(R.styleable.base_SwipeBackLayout_base_edge_size, -1);
        if (edgeSize > 0)
            setEdgeSize(edgeSize);
        int mode = EDGE_FLAGS[a.getInt(R.styleable.base_SwipeBackLayout_base_edge_flag, 0)];
        setEdgeTrackingEnabled(mode);

        int shadowLeft = a.getResourceId(R.styleable.base_SwipeBackLayout_base_shadow_left,
                R.drawable.base_shadow_left);
        int shadowRight = a.getResourceId(R.styleable.base_SwipeBackLayout_base_shadow_right,
                R.drawable.base_shadow_right);
        int shadowBottom = a.getResourceId(R.styleable.base_SwipeBackLayout_base_shadow_bottom,
                R.drawable.base_shadow_bottom);
