...
package com.kymjs.core.http;


import com.kymjs.core.Core;
import com.kymjs.core.interf.IHttpStack;
import com.kymjs.core.toolbox.HTTPSTrustManager;
...
public class HttpConnectStack implements IHttpStack {
    ...
    static void setConnectionParametersForRequest(HttpURLConnection connection, Request<?> request)
        ...
        switch (request.getMethod()) {
            case Core.Method.GET:
                connection.setRequestMethod("GET");
                break;
            case Core.Method.DELETE:
                connection.setRequestMethod("DELETE");
                break;
            case Core.Method.POST:
                connection.setRequestMethod("POST");
                addBodyIfExists(connection, request);
                break;
            case Core.Method.PUT:
                connection.setRequestMethod("PUT");
                addBodyIfExists(connection, request);
                break;
            case Core.Method.HEAD:
                connection.setRequestMethod("HEAD");
                break;
            case Core.Method.OPTIONS:
                connection.setRequestMethod("OPTIONS");
                break;
            case Core.Method.TRACE:
                connection.setRequestMethod("TRACE");
                break;
            case Core.Method.PATCH:
